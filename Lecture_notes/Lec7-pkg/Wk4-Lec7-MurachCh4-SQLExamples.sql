...
FROM   departments_ex d LEFT JOIN employees e
...
-- Sort the result in increasing order of department names, then last names, and then project numbers.
SELECT department_name,  last_name, project_number AS proj_no
FROM   departments_ex d RIGHT JOIN employees e
           ON d.department_number = e.department_number
...
SELECT department_name, last_name, project_number AS proj_no
FROM   departments_ex d FULL JOIN employees e
           ON d.department_number = e.department_number
...
SELECT department_name, last_name, project_number AS proj_no
FROM   departments_ex d JOIN employees e
           ON d.department_number = e.department_number
       LEFT JOIN projects p
           ON e.employee_id = p.employee_id
ORDER BY department_name, last_name, project_number;
...
FROM departments_ex CROSS JOIN employees
ORDER BY departments_ex.department_number;
